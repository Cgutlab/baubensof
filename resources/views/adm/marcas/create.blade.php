		...
		<div class="row">
			...
			<div class="col s12">
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('MarcaController@store')}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					...
					<div class="row">
						...
						<div class="file-field input-field s12">
							...
							<div class="file-path-wrapper">
								...
								<span class="helper-text" data-error="wrong" data-success="right">Tamaño recomendado: 180x70</span>
							</div>
						</div>
					</div>
					...
					<div class="right">
						<a href="{{ action('MarcaController@index') }}" class="waves-effect waves-light btn">Cancelar</a>
