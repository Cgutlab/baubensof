	...
	<div class="container" id="container-fluid">
		<div class="row">
			...
			<div class="col s12" style="padding-left: 40px;padding-right: 40px;">
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('ObraController@update', $obra->id)}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					{{ csrf_field() }}    
					{{ method_field('PUT')}}  
					...
					<div class="row">
						...
						<div class="input-field col s6">
							...
							<input id="icon_prefix" type="text" class="validate" name="nombre"  value="{{ $obra->nombre }}">
							<label for="icon_prefix">Nombre</label>
						</div>

						<div class="input-field col s6">
							<i class="material-icons prefix">text_rotation_none</i>
							<input id="icon_prefix" type="text" class="validate" name="orden"  value="{{ $obra->orden }}">
							<label for="icon_prefix">Orden</label>
						</div>
					</div>

					<div class="right">
						<a href="{{ action('ObraController@index') }}" class="waves-effect waves-light btn">Cancelar</a>
